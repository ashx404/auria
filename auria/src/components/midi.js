!(function(e) {
  function n() {
    ...
    (n = r.indexOf("Opera")) != -1
      ? ((o = "Opera"),
        (a = r.substring(n + 6)),
        (n = r.indexOf("Version")) != -1 && (a = r.substring(n + 8)))
      : (n = r.indexOf("MSIE")) != -1
      ? ((o = "Microsoft Internet Explorer"), (a = r.substring(n + 5)))
      : (n = r.indexOf("Trident")) != -1
      ? ((o = "Microsoft Internet Explorer"),
        (a = (n = r.indexOf("rv:")) != -1 ? r.substring(n + 3) : "0.0"))
      : (n = r.indexOf("Chrome")) != -1
      ? ((o = "Chrome"), (a = r.substring(n + 7)))
      : (n = r.indexOf("Android")) != -1
      ? ((o = "Android"), (a = r.substring(n + 8)))
      : (n = r.indexOf("Safari")) != -1
      ? ((o = "Safari"),
        (a = r.substring(n + 7)),
        (n = r.indexOf("Version")) != -1 && (a = r.substring(n + 8)))
  ...
  function t(e, n) {
      ...
      if (k == r) {
        ...
        return (
          (newjs.onreadystatechange = function() {
            ("loaded" !== newjs.readyState &&
              "complete" !== newjs.readyState) ||
              ((newjs.onreadystatechange = null), (K = !0), o(), n());
          }),
    ...
    (newjs = document.createElement("script")),
      (newjs.onreadystatechange = function() {
        ("loaded" !== newjs.readyState && "complete" !== newjs.readyState) ||
          ((newjs.onreadystatechange = null), (K = !0), n());
      }),
  ...
  function r(e) {
    if (
      ...
      return void p();
    for (var n = Math.pow(2, 15), t = 0; t < R; t++)
      t < H
        ? (e.outputBuffer.getChannelData(0)[t] =
            Module.getValue(O + 2 * t, "i16") / n)
        : (e.outputBuffer.getChannelData(0)[t] = 0);
    0 == z && (z = S.currentTime);
  }
  function o(e, n, t) {
    ...
    o.open("GET", n + t, !0),
      ...
      (o.onload = function() {
        if (200 != o.status)
          return void A(
            "Error: Cannot retrieve patch file " + n + t + " : " + o.status
          );
        if (
          (F--,
          FS.createDataFile("pat/", t, new Int8Array(o.response), !0, !0),
          MIDIjs.message_callback &&
            F > 0 &&
            MIDIjs.message_callback("Instruments to be loaded: " + F),
          A("Instruments to be loaded: " + F),
          0 == F)
        ) {
          var a = Module.ccall(
          ...
          Module.ccall("mid_song_start", "void", ["number"], [W]),
            (V = S.createScriptProcessor(R, 0, 1)),
            (O = Module._malloc(2 * R)),
            (V.onaudioprocess = r),
  ...
  function a(e) {
    ...
    n.open("GET", e, !0),
      ...
      (n.onload = function() {
        if (200 != n.status)
          return void A("Error: Cannot preload file " + e + " : " + n.status);
      }),
      n.send();
  }
  function i() {
    var e = new Object();
    0 != z ? (e.time = S.currentTime - z) : (e.time = 0),
  ...
  function c(e) {
    S ||
      ...
      (S = new AudioContext())),
      S.resume ? S.resume().then(d(e)) : d(e);
  }
  function d(e) {
    (z = 0),
      i(),
      A("Loading libtimidity ... "),
      t(k, function() {
        m(e, f, null);
      });
  }
  function m(e, n, t) {
    ...
    A("Loading MIDI file " + e + " ..."),
      t || MIDIjs.message_callback("Loading MIDI file " + e + " ...");
    ...
    i.open("GET", e, !0),
      ...
      (i.onload = function() {
        if (200 != i.status)
          return void A(
            "Error: Cannot retrieve MIDI file " + e + " : " + i.status
          );
  ...
  function f(e, n, t) {
    (E = Module._malloc(n.length)),
      Module.writeArrayToMemory(n, E),
  ...
  function b(e, n, t) {
    X || ((X = !0), (R = L), c(q + "../midi/initsynth.midi")),
      0 != W &&
        Module.ccall(
          "mid_song_note_on",
          "void",
  ...
  function p() {
    V && (V.disconnect(), (V.onaudioprocess = 0), (V = 0)),
      W &&
        (Module._free(O),
        Module._free(E),
        Module.ccall("mid_song_free", "void", ["number"], [W]),
        (W = 0));
  }
  function g() {
  ...
  function M(e) {
    return (
      "undefined" == typeof N && (N = document.createElement("a")),
      (N.href = e),
      N.href
    );
  }
  ...
  function v() {
    var e = new Object();
    0 == z && (z = new Date().getTime()),
      (e.time = (new Date().getTime() - z) / 1e3),
      MIDIjs.player_callback && MIDIjs.player_callback(e);
  }
  function j(e) {
    w(), (url = _(e));
    ...
    n
      ? n.lastChild.setAttribute("src", url)
  ...
  function w() {
    if (V) {
      var e = V;
      e.lastChild.setAttribute("src", _(q) + "silence.mid"),
        clearInterval(P),
        (V = 0);
    }
    A(G);
  ...
  function y(e) {
    ...
    var n = document.getElementById("scorioMIDI");
    n
      ? n.lastChild.setAttribute("data", e)
      : ((n = document.createElement("div")),
        n.setAttribute("id", "scorioMIDI"),
        (n.innerHTML =
          '<object data="' +
  ...
  try {
    ...
    try {
      ...
      C =
        "Microsoft Internet Explorer" == Q.browserName
          ? "bgsound"
          : "Android" == Q.browserName
          ? "none"
          : "object";
    }
    (e.MIDIjs.set_logging = function(e) {
      ...
      (e.MIDIjs.get_duration = function(e, n) {
        "Microsoft Internet Explorer" == Q.browserName && Q.fullVersion < 10
          ? n && n(-1)
          : t(k, function() {
              m(e, h, n);
            });
      ...
      "WebAudioAPI" == C
        ? ((e.MIDIjs.resumeWebAudioContext = u),
          ...
          (G =
            ...
            R),
          (e.MIDIjs.noteOn = b),
          (e.MIDIjs.startSynth = I))
        : "bgsound" == C
        ? ((e.MIDIjs.play = j),
          (e.MIDIjs.stop = w),
          (G = "audioMethod: &lt;bgsound&gt;"))
        : "object" == C
        ? ((e.MIDIjs.play = y),
          (e.MIDIjs.stop = D),
          (G = "audioMethod: &lt;object&gt;"))
        : ((e.MIDIjs.play = function(e) {}),
          (e.MIDIjs.stop = function(e) {}),
          (G = "audioMethod: No method found")),
      "Microsoft Internet Explorer" == Q.browserName &&
        "https:" == location.protocol.toLowerCase() &&
        setTimeout(function() {
          j(_(q) + "silence.mid"), clearInterval(P);
        }, 1),
      (-1 == location.href.indexOf("scorio.com") &&
        -1 == location.href.indexOf("weblily.net") &&
        -1 == location.href.indexOf("local")) ||
        ("WebAudioAPI" == C &&
          (a(q + "pat/arachno-127.pat"),
